...
knitr::kable(as.array(summary(train.c1$count)))
...
```{r correlation-plot-full, message=FALSE, echo=FALSE}
...
```{r linechart-hourly-bike-count-by-feels-like-tempurature-full, message=FALSE, echo=FALSE}
train.c1 %>%
...
```{r linechart-hourly-bike-count-by-windspeed-full, message=FALSE, echo=FALSE}
...
p1 <- plotts.sample.wge(train.2012.june$count)
...
```{r acf-june-2012, results='hide', message=FALSE, include=FALSE, echo=FALSE}
...
```{r arma-forecasts-seven-days-three, message=FALSE, echo=FALSE}
...
```{r arma-forecasts-one-day-three, message=FALSE, echo=FALSE}
...
```{r var-seven-days-forecast-plot, message=FALSE, echo=FALSE}
...
```{r var-one-day-forecast-plot, message=FALSE, echo=FALSE}
...
```{r mlp-seven-day-forecast-plot, message=FALSE, echo=FALSE}
...
```{r mlp-one-day-forecast-plot, message=FALSE, echo=FALSE}
...
knitr::kable(head(df.ensemble.seven.days))
...
knitr::kable(head(df.ensemble.one.day))
...
```{r ensemble-seven-day-forecast-ase, results='hide', message=FALSE, include=FALSE, echo=FALSE}
...
```{r ensemble-seven-day-forecast-rmse, results='hide', message=FALSE, include=FALSE, echo=FALSE}
...
```{r ensemble-one-day-forecast-ase, results='hide', message=FALSE, include=FALSE, echo=FALSE}
...
```{r ensemble-one-day-forecast-rmse, results='hide', message=FALSE, include=FALSE, echo=FALSE}
